...
**P1 complete:** full end-to-end booking — service catalog, doctor profiles + weekly schedules, availability engine, bcmath pricing with home surcharge, transactional BookingService (double-booking guard), shared BookingWizard (portal self + admin on-behalf + quick-create), 7-state appointment lifecycle with server-side enforcement, admin and customer appointment management; 140 tests green, 0 regressions.
