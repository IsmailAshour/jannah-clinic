...
<template>
  <AdminShell>
    <div class="p-4 sm:p-6 max-w-2xl mx-auto">
      ...
      <!-- Catch-all banner for any other validation error we don't render
           inline (services.*, doctor, start, discount_*, etc.). Without
           this, a submit can fail silently and the page looks frozen. -->
      <div
