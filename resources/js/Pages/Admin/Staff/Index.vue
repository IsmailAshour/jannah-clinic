...
import { UserPlus, Pencil, Trash2, KeyRound, Power, AlertCircle } from 'lucide-vue-next'
...
const tempPasswordForUserId = computed(() => page.props.flash?.temp_password_for_user_id ?? null)
...
<template>
  <AdminShell>
    <div class="p-4 sm:p-6 space-y-6">
      ...
      <AdminDataTable :columns="columns" :data="staff" empty-text="لا يوجد موظّفون بعد." />
